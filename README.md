...
```sh
$ npm install react-native-screenshotblocker --save
```

```sh
$ yarn add react-native-screenshotblocker
```
...
```sh
$ npm install react-native-screenshotblocker@beta --save

```

```sh
$ yarn add react-native-screenshotblocker@beta
```
...
- React-native 0.59 and lower: Please do manual installation as follow
  ...
  #### iOS
    ...
    2. Go to `node_modules` ➜ `react-native-screenshotblocker` and add `ScreenGuard.xcodeproj`
  ...
  #### Android
    ...
    2. Append the following lines to `android/settings.gradle`:
  	...
  	```
  	include ':react-native-screenshotblocker'
  	project(':react-native-screenshotblocker').projectDir = new File(rootProject.projectDir,'../node_modules/react-native-screenshotblocker/android')
  	```

    3. Insert the following lines inside the dependencies block in `android/app/build.gradle`:

  	```
      compile project(':react-native-screenshotblocker')
  	```
...
```js
import ScreenGuardModule from 'react-native-screenshotblocker';
...
https://github.com/gbumps/react-native-screenshotblocker/assets/16846439/fd4b3662-6e3b-4428-a927-23ee2068c22a 

Android

https://github.com/gbumps/react-native-screenshotblocker/assets/16846439/da99c58c-fb79-4885-b496-ecb242bd4cf8
...
https://github.com/gbumps/react-native-screenshotblocker/assets/16846439/17429686-1bc4-4d5b-aa6c-82616ec8d1c5
...
https://github.com/YarenWolf/react-native-screenshotblocker/tree/master/ios

Android

https://github.com/YarenWolf/react-native-screenshotblocker/tree/master/android
